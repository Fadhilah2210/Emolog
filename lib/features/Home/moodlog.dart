...
class _MoodLogScreenState extends State<MoodLogScreen> {
  ...
  // Declare currentNavIndex to track the selected index in BottomNavigationBar
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: CustomBottomNavBar(
        currentIndex: currentNavIndex, // Pass the current index here
        onTap: (index) {
          setState(() {
            currentNavIndex = index; // Update currentNavIndex when a tab is tapped
          });
        },
      ),
    );
